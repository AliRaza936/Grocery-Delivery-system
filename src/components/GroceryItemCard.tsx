...
function GroceryItemCard({item}:{item:IGrocery}) {
  ...
  return (
    ...
    >
      ...
      <motion.button className='mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full py-2 text-sm font-medium transition-all cursor-pointer'
      whileTap={{scale:0.96}}
      >
