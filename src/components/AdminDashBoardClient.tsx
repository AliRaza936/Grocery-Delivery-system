    ...
    <div className="pt-28 w-[90%] md:w-[80%] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 text-center sm:text-left">
        ...
        >
          ...
          <option value="today">Today Earning</option>
        </select>
      </div>
        <motion.div
        ...
        >
            ...
            <p className="text-4xl font-extrabold text-green-800">Rs.{currentEarning.toLocaleString()}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {stats?.map((s,i)=>{
                const icons = [
                    ...
                    <p key="r" className="text-green-700 font-semibold  w-6 text-center scale-110">Rs</p>,
                ]
                return <motion.div
                key={i}
                         initial={{ opacity: 0, y: 20 }}
