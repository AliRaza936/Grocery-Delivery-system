...
const HeroSection = () => {
  ...
  },
  {
    ...
    btnText: "Order Now",
    bg: "https://plus.unsplash.com/premium_photo-1661546678463-7bdfeb8b221e?q=80&w=869&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    id: 3,
    icon: (
...
const timer = setInterval(()=>{
  ...
  return (
    <div className='w-[98%] relative mx-auto mt-28 h-[60vh] md:h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
      ...
      <div className='absolute bottom-6 flex gap-3 left-1/2 -translate-x-1/2'>
        {slides.map((_,index)=>(
            <button
            key={index}
