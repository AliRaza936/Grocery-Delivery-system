            ...
            <div className="flex items-center gap-3 p-3 mt-3 rounded-xl bg-white/10 hover:bg-white/15 transition-all shadow-inner">
              ...
              >
                {user?.image ? (
                  ...
                  <div className="flex justify-center bg-green-200 rounded-full  w-full h-full items-center">
      ...
      <div className="flex items-center gap-3 md:gap-6 relative ">
        ...
        {(user?.role == "admin" || user?.role == "dummy_admin") && (
          <>
            ...
            <div
              className="md:hidden cursor-pointer bg-white rounded-full w-10 h-10 flex items-center justify-center shadow-md"
              ...
              >
                {user ? (
                  <div>
                    ...
                    <div className="text-gray-600 text-xs flex justify-center border-b pb-2 border-gray-100">
                          {user?.email}
                        </div>
                    {(!user || user?.role == "user") && (
                      <Link
